...
public class LeaveHistoryActivity extends SherlockFragmentActivity {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		menu.add(R.string.menu_add).setIcon(R.drawable.ic_menu_add).setShowAsAction(MenuItem.SHOW_AS_ACTION_IF_ROOM);
		menu.add(R.string.menu_edit_cat).setShowAsAction(MenuItem.SHOW_AS_ACTION_WITH_TEXT);
